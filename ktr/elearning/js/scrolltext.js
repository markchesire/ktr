...
var fontfamily = '0 1px 2px rgba(0, 0, 0, 0.6)'; // font for content
var tSpeed=1;                        // scroll speed (1 = slow, 5 = fast)

// enter your ticker content here (use \/ and \' in place of / and ' respectively)
var content='Kituro e-learning platform';
...
if (document.getElementById) 
    {
        ...
        tick +='><div id="mq" style="position:absolute;right:0px;top:0px;color:#006600;'+fontfamily+';font-size:'+fsz+'px;white-space:nowrap;"><\/div><\/div>'; 
