...
// Form validation code will come here.
   ...
   function checkRegister()
      ...
      {  
		 ...
		 {
         alert("Invalid input for mobilenumber.Try again e.g +254726 xxx xxx");
		 ...
		 if( document.registerForm.password.value == "" || !re.test(document.registerForm.password.value)) 
		 {
         alert("Invalid input for password!.use correct password ");
