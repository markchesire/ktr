...
<html lang="en">
  <head>
    <title>elearn | Biology Book3</title>
    <meta charset="utf-8">
    ...
    <div class="row">
      <div class="span3 bs-docs-sidebar">
        <ul class="nav nav-list bs-docs-sidenav">
          ...
          <li><a href="#transitions"><i class="icon-chevron-right"></i>Classification II</a></li>
          <li><a href="#modals"><i class="icon-chevron-right"></i>Ecology</a></li>
          <li><a href="#dropdowns"><i class="icon-chevron-right"></i>Reproduction in Plants and Animals</a></li>
          <li><a href="#scrollspy"><i class="icon-chevron-right"></i>Growth and Development</a></li>
        </ul>
      </div>
      <div class="span9">
        <!-- Overview -->
        ...
        <section id="transitions">
          <div class="page-header">
            <h4 id="topic-header">Classification II<small> Let learn about Classification II</small></h4>
          </div>
          <h6>Classification II</h6>
		      <a href="https://example.com/test.pdf" id="unitdownload">Click here to download</a>.</p>
        </section>
        <!--Ecology-->
        <section id="modals">
          <div class="page-header">
            <h4 id="topic-header">Ecology<small>&nbsp;Let's learn about Ecology</small></h4>
          </div>
          <h6>Ecology</h6>
          <a href="https://example.com/test.pdf" id="unitdownload">Click here to download</a>.</p>
        </section>
        ...
        <section id="dropdowns">
          <div class="page-header">
            <h4 id="topic-header">Reproduction in Plants and Animals<small>&nbsp;let's learn about this now</small></h4>
          </div>
          <h6>Reproduction in Plants and Animals</h6>
          <a href="https://example.com/test.pdf" id="unitdownload">Click here to download</a>.</p>
        </section>
        <!--Growth and Development-->
        <section id="scrollspy">
          <div class="page-header">
            <h4 id="topic-header">Growth and Development<small>&nbsp;Let's learn about Growth and Development now</small></h4>
          </div>
