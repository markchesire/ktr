          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="home" id="brand-desc">
                <a href="directory-1993.php">&laquo;&nbsp;Back </a>
              </li>
    ...
    <div class="row">
      <div class="span3 bs-docs-sidebar" >
        <ul class="nav nav-list bs-docs-sidenav" id="navigation">
          <li><a href="#overview"><i class="icon-chevron-right"></i>1985</a></li>
          <li><a href="#transitions"><i class="icon-chevron-right"></i>1984</a></li>
          <li><a href="#modals"><i class="icon-chevron-right"></i>1983</a></li>
          <li><a href="#dropdowns"><i class="icon-chevron-right"></i>1982</a></li>
          <li><a href="#scrollspy"><i class="icon-chevron-right"></i>1981</a></li>
          <li><a href="#tabs"><i class="icon-chevron-right"></i>1980</a></li>
          <li><a href="#tooltips"><i class="icon-chevron-right"></i>1979</a></li>
          <li><a href="#popovers"><i class="icon-chevron-right"></i>1978</a></li>
        </ul>
      </div>
      <div class="span9" id="navigation-list">
        ...
        <section id="overview">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1985&nbsp;Alumni</em></h4>
          </div>
		...
		<?php  
				...
				$sqlquery = "select * from dir_alumni where endyear = '1985' ORDER BY firstname";
        ...
        <section id="transitions">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1984 &nbsp;Alumni</em></h4>
			<?php  
			 
				$sqlquery = "select * from dir_alumni where endyear = '1984' ORDER BY firstname";
				$result = mysqli_query($dblink,$sqlquery);
				while($row = mysqli_fetch_array($result))
					echo "
        ...
        <section id="modals">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1983 &nbsp;Alumni</em></h4>
			<?php  
			 
				$sqlquery = "select * from dir_alumni where endyear = '1983' ORDER BY firstname";
				$result = mysqli_query($dblink,$sqlquery);
				while($row = mysqli_fetch_array($result))
					echo "
        ...
        <section id="dropdowns">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1982 &nbsp;Alumni </em></h4>
			<?php  
        ...
        <section id="scrollspy">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1981 &nbsp;Alumni</em></h4>
			<?php  
        ...
        <section id="tabs">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1980 &nbsp;Alumni</em></h4>
			<?php  
			 
				$sqlquery = "select * from dir_alumni where endyear = '1980' ORDER BY firstname";
				$result = mysqli_query($dblink,$sqlquery);
				while($row = mysqli_fetch_array($result))
					echo "
        ...
        <section id="tooltips">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1979 &nbsp;Alumni</em></h4>
			<?php  
			 
				$sqlquery = "select * from dir_alumni where endyear = '1979' ORDER BY firstname";
				$result = mysqli_query($dblink,$sqlquery);
				while($row = mysqli_fetch_array($result))
					echo "
      ...
      <section id="popovers">
        <div class="page-header">
          <h4 id="topic-header">&nbsp;<em>1978 &nbsp;Alumni</em></h4>
		  <?php  
			 
				$sqlquery = "select * from dir_alumni where endyear = '1978' ORDER BY firstname";
				$result = mysqli_query($dblink,$sqlquery);
				while($row = mysqli_fetch_array($result))
					echo "
		   ...
		   <div class="row text-center">
            ...
            <div class="col-lg-12" id="pagination-list">
                <ul id="pagination">
					...
					<li><a href="directory-1977.php">next</a></li>
