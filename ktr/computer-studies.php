...
<html lang="en">
  <head>
    <title>elearn | Computer Studies page1</title>
    <meta charset="utf-8">
    ...
    <div class="row">
      <div class="span3 bs-docs-sidebar">
        <ul class="nav nav-list bs-docs-sidenav">
          ...
          <li><a href="#transitions"><i class="icon-chevron-right"></i>Introduction to Computer studies</a></li>
          <li><a href="#modals"><i class="icon-chevron-right"></i>Computer Systems</a></li>
          <li><a href="#dropdowns"><i class="icon-chevron-right"></i>Operating Systems</a></li>
        </ul>
      </div>
      <div class="span9">
        <!-- Overview -->
        ...
        <section id="transitions">
          <div class="page-header">
            <h4 id="topic-header">Introduction to Computer studies<small>&nbsp;let's learn about this now</small></h4>
          </div>
          <h6>Introduction to Computer studies</h6>
          <a href="https://example.com/test.pdf" id="unitdownload">Click here to download</a>.</p>
        </section>
        <!--Computer Systems-->
        <section id="modals">
          <div class="page-header">
            <h4 id="topic-header">Computer Systems<small>&nbsp;Let's learn about this now</small></h4>
          </div>
        ...
        <section id="dropdowns">
          <div class="page-header">
            <h4 id="topic-header">Operating Systems<small>&nbsp;let's learn about this now</small></h4>
          </div>
        ...
        <div class="row text-center">
            <div class="col-lg-12">
                <ul id="pagination">
                    <li class=""><a href="computer-studies.php">Top</a>
                    </li> 
                </ul>
            </div>
            </div>
