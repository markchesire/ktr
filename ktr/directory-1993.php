          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="home" id="brand-desc">
                <a href="directory-2001.php">&laquo;&nbsp;Back </a>
              </li>
    ...
    <div class="row">
      <div class="span3 bs-docs-sidebar" >
        <ul class="nav nav-list bs-docs-sidenav" id="navigation">
          <li><a href="#overview"><i class="icon-chevron-right"></i>1993</a></li>
          <li><a href="#transitions"><i class="icon-chevron-right"></i>1992</a></li>
          <li><a href="#modals"><i class="icon-chevron-right"></i>1991</a></li>
          <li><a href="#dropdowns"><i class="icon-chevron-right"></i>1990</a></li>
          <li><a href="#scrollspy"><i class="icon-chevron-right"></i>1989</a></li>
          <li><a href="#tabs"><i class="icon-chevron-right"></i>1988</a></li>
          <li><a href="#tooltips"><i class="icon-chevron-right"></i>1987</a></li>
          <li><a href="#popovers"><i class="icon-chevron-right"></i>1986</a></li>
        </ul>
      </div>
      <div class="span9" id="navigation-list">
        ...
        <section id="overview">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1993&nbsp;Alumni</em></h4>
          </div>
		...
		<?php  
				...
				$sqlquery = "select * from dir_alumni where endyear = '1993' ORDER BY firstname";
        ...
        <section id="transitions">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1992 &nbsp;Alumni</em></h4>
			<?php  
			 
				$sqlquery = "select * from dir_alumni where endyear = '1992' ORDER BY firstname";
				$result = mysqli_query($dblink,$sqlquery);
				while($row = mysqli_fetch_array($result))
					echo "
        ...
        <section id="modals">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1991 &nbsp;Alumni</em></h4>
			<?php  
        ...
        <section id="dropdowns">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1990 &nbsp;Alumni </em></h4>
			<?php  
        ...
        <section id="scrollspy">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1989 &nbsp;Alumni</em></h4>
			<?php  
			 
				$sqlquery = "select * from dir_alumni where endyear = '1989' ORDER BY firstname";
				$result = mysqli_query($dblink,$sqlquery);
				while($row = mysqli_fetch_array($result))
					echo "
        ...
        <section id="tabs">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1988 &nbsp;Alumni</em></h4>
			<?php  
			 
				$sqlquery = "select * from dir_alumni where endyear = '1988' ORDER BY firstname";
				$result = mysqli_query($dblink,$sqlquery);
				while($row = mysqli_fetch_array($result))
					echo "
        ...
        <section id="tooltips">
          <div class="page-header">
            <h4 id="topic-header">&nbsp;<em>1987 &nbsp;Alumni</em></h4>
			<?php  
			 
				$sqlquery = "select * from dir_alumni where endyear = '1987' ORDER BY firstname";
				$result = mysqli_query($dblink,$sqlquery);
				while($row = mysqli_fetch_array($result))
					echo "
      ...
      <section id="popovers">
        <div class="page-header">
          <h4 id="topic-header">&nbsp;<em>1986 &nbsp;Alumni</em></h4>
		  <?php  
			 
				$sqlquery = "select * from dir_alumni where endyear = '1986' ORDER BY firstname";
				$result = mysqli_query($dblink,$sqlquery);
				while($row = mysqli_fetch_array($result))
					echo "
		   ...
		   <div class="row text-center">
            ...
            <div class="col-lg-12" id="pagination-list">
                <ul id="pagination">
                    ...
                    <li><a href="directory-1985.php">next</a></li>
